...
preview: '<iframe frameborder="0" src="https://itch.io/embed-upload/16444340?color=333333" allowfullscreen="" style="aspect-ratio: 0.66"><a href="https://easy-h.itch.io/crossnumber">Play Cross Number on itch.io</a></iframe>'
social:
  - title: github
    info: Code
...
- 레벨 편집 및 공유 기능 탑재
    - 스테이지 공유 전에 맵 제작자가 직접 스테이지를 클리어하는 과정을 요구
    - 클리어 불가능한 스테이지의 업로드를 차단
<!-- card: 🛠️ 주요 기능 및 기여 -->
...
- 사용자 로그인 및 게임 데이터를 Firebase를 이용하여 관리
    - Firebase가 JavaScript로 제공되는 점과 Unity의 jslib 지원을 활용하여 WebGL 환경에서도 동작하도록 구현
...
### 🧩 퍼즐 정보
- **MapId**와 **MapData**로 컬렉션을 나누어 정규화된 구조로 저장
